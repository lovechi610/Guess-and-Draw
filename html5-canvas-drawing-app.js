...
var colorGreen = "#b0fa87";
var colorYellow = "#ffcf33";
var colorBrown = "#87d3fa";
var colorBlue = "#87d3fa";
...
function prepareCanvas()
{
	...
	var picSetNum = 3;
	var randomPickPic = Math.floor(Math.random()*3)
	outlineImage.src = "images/mypic"+ randomPickPic +".png";
	...
	$('#canvas').mousemove(moveevent);
	
	$('#canvas').mouseup(upevent);
	
	$('#canvas').mouseleave(leaveevent);
